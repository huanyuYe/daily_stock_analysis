...
| [Cross-market theme report](cross-market-theme-report.md) <sub><sub>![P2 Badge](https://img.shields.io/badge/P2-yellow?style=flat)</sub></sub> (Chinese-only) | Twice-daily US catalyst mapping and A/HK close validation, evidence boundaries, theme catalog, and systemd schedule |
