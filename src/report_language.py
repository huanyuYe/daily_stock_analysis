...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "conditional_entry_label": "条件入场参考",
        "secondary_conditional_entry_label": "次级条件入场参考",
        "holding_risk_label": "持仓风控线",
        "holding_target_label": "持仓止盈观察位",
        "exit_reference_label": "退出参考位",
    ...
    "en": {
        ...
        "conditional_entry_label": "Conditional Entry Reference",
        "secondary_conditional_entry_label": "Secondary Conditional Entry",
        "holding_risk_label": "Holding Risk Line",
        "holding_target_label": "Holding Take-Profit Watch",
        "exit_reference_label": "Exit Reference",
    ...
    "ko": {
        ...
        "conditional_entry_label": "조건부 진입 참고가",
        "secondary_conditional_entry_label": "2차 조건부 진입 참고가",
        "holding_risk_label": "보유 리스크 관리선",
        "holding_target_label": "보유 익절 관찰가",
        "exit_reference_label": "청산 참고가",
